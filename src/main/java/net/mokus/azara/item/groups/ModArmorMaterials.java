...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ABYSS_NETHERITE("abyss_netherite",25,new int[]{2,7,5,2},19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,1.0f,0f,() -> Ingredient.ofItems(ModItems.ABYSS_DUST));
