...
public class AzaraSword extends SwordItem implements DamageTrackingWeapon {
    private static final String DAMAGE_KEY = "DamageDealt";
    public static final int DAMAGE_THRESHOLD = 40; // 20 hearts

    public AzaraSword(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
        ...
        if (!world.isClient) {
            ...
            if (damageDealt >= DAMAGE_THRESHOLD) {
                ...
                for (LivingEntity entity : entities) {
                    entity.addStatusEffect(new StatusEffectInstance(ModEffects.ABYSSEFFECT, 400, 1));
                }
                ...
                for (double currentRadius = 2.0; currentRadius <= radius; currentRadius += 0.5) {
